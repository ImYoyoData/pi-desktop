...
export const en = {
	...
	changesGitUnavailableHint:
		"Run npm run dugite:git (or reinstall deps without --ignore-scripts), then restart.",
	...
	changesDiscardConfirmSelected:
		"Discard local changes in selected files? Untracked files will be deleted. This cannot be undone.",
	...
	changesetUncommitted: "Uncommitted Changes",
	changesetSession: "Session Changes",
	changesetTurn: "Last Turn Changes",
	changesetTurnDesc: "Show only changes made in the last turn",
	changesVersions: "Versions",
	changesWelcomeTitle: "Changes",
	changesWelcomeEmpty: "No changed files",
	changesViewAll: "View All Changes",
	...
	changesPullNew: (n: number) =>
		n === 1 ? "1 new commit to pull" : `${n} new commits to pull`,
	changesNewEmpty: "Empty file (no content)",
	...
	changesDeleteBranchPrompt:
		"Select a local branch to delete (merged branches delete safely)",
	...
	changesConflictBanner:
		"Merge conflicts detected. Resolve conflicted files, then commit.",
	...
	changesConflictNoMarkers:
		"No conflict markers in file. Use All ours or All theirs.",
	changesConflictMalformed: "Conflict markers are malformed",
	changesConflictAbort: "Abort merge",
	changesConflictAbortConfirm:
		"Abort the current merge? Conflicted files will be restored to the pre-merge state.",
	...
	lanConsoleCreds: "Login credentials",
	...
	lanConsoleRegenerate: "Regenerate token",
	lanConsolePort: "Port",
	...
	lanConsoleTokenRegenerated: "Token regenerated",
