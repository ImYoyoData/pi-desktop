...
export const en = {
	...
	customizeModelsConfigure: "Configure Models",
	customizeModelsCount: (n: number) => `${n} model${n === 1 ? "" : "s"}`,
	customizeModelsConfigured: "Configured",
	customizeModelsUnconfigured: "Not configured",
	...
	modelsCustomFormHint:
		"Fill connection details → Fetch models only updates the draft below → click Save when ready. Remote keys go to auth.json (same as Pi /login).",
	...
	modelsCustomTestNeedModel: "Add at least one model ID before testing",
	modelsCustomContextWindow: "Context window",
	modelsCustomMaxTokens: "Max output",
	modelsCustomVision: "Vision",
	modelsCustomSave: "Save",
	modelsCustomSaveHint: "Save writes ~/.pi/agent/models.json",
	modelsCustomApiKeyAuthHint:
		"Remote keys are stored in auth.json (like Pi /login), not plaintext in models.json.",
	modelsCustomApiKeyModelsHint:
		"Local placeholders or $ENV / !command stay in models.json (Pi docs).",
	...
	modelsCustomApiKeyHint:
		"Local servers can use a dummy like ollama; remotes need a real key",
	...
	modelsDeleteProvider: "Delete this provider",
	modelsProviderDeleted: "Provider deleted",
	modelsPullModels: "Pull",
