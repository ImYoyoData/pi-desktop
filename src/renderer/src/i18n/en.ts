...
export const en = {
	...
	lanPublicHint:
		"Off by default. When enabled, a Cloudflare tunnel (cloudflared) publishes an HTTPS public URL so you can connect from outside your LAN.",
	lanPublicWarning: "Anyone who gets the public URL can try to sign in — keep the PIN private.",
	lanPublicUrl: "Public URL",
	lanPublicStarting: "Connecting to the public network (cloudflared downloads automatically on first use, ~30MB)…",
	lanPublicDownloading: "Downloading cloudflared…",
	...
	lanPublicTemporary: "This URL changes whenever the tunnel restarts — copy it again afterwards.",
	lanPublicNotInstalled: "cloudflared is not installed yet; it downloads automatically when enabled.",
	aboutTitle: "About",
