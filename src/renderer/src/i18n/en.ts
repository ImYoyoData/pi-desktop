...
export const en = {
	...
	agentWaitWriting: "Writing reply…",
	agentWaitTool: (name: string) => `Running tool · ${name}`,
	agentWaitToolGeneric: "Running tools…",
	...
	processThoughtFor: (duration: string) => `Thought ${duration}`,
	processThoughtBriefly: "Thought briefly",
	processPlanning: "Planning next moves",
	agentBadge: "agent",
	streamingStatus: "Streaming",
	streamingCompleted: "Streaming completed",
	processEditedFiles: (n: number) =>
		n === 1 ? "Edited 1 file" : `Edited ${n} files`,
	processEditingFiles: (n: number) =>
		n === 1 ? "Editing 1 file" : `Editing ${n} files`,
	processExploredFiles: (n: number) =>
		n === 1 ? "explored 1 file" : `explored ${n} files`,
	processExploringFiles: (n: number) =>
		n === 1 ? "Exploring 1 file" : `Exploring ${n} files`,
	processSearches: (n: number) =>
		n === 1 ? "1 search" : `${n} searches`,
	processOtherTools: (n: number) =>
		n === 1 ? "1 tool" : `${n} tools`,
	processSummarySep: ", ",
	processStepRead: "Read",
	processStepEdited: "Edited",
	processStepGrepped: "Grepped",
	processStepRan: "Ran",
	processStepUsed: "Used",
	processStepThought: "Thought",
	processStepBriefly: "briefly",
	processStepReading: "Reading",
	processStepEditing: "Editing",
	processStepSearching: "Searching",
	processStepRunning: "Running",
	filesChanged: (n: number) =>
		n === 1 ? "1 File Changed" : `${n} Files Changed`,
	reviewChanges: "Review",
	showMoreFiles: (n: number) => `Show more (${n})`,
	showLessFiles: "Show less",
	toolsCalledCount: (n: number) =>
		n === 1 ? "Called 1 tool" : `Called ${n} tools`,
	toolsRunning: "Running tools…",
	toolsRunningHint: (name: string) => `Running tool · ${name}`,
	...
	toolRead: "Read",
	toolBash: "Ran",
	toolGroupReadTimes: (n: number) =>
		n === 1 ? "Read 1 file" : `Read ${n} files`,
	toolGroupToolTimes: (n: number) =>
		n === 1 ? "Called 1 tool" : `Called ${n} tools`,
	toolGroupJoin: ", ",
