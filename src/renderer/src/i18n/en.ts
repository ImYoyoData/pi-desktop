...
export const en = {
	...
	wsSummaryBash: (n: number) => (n === 1 ? "Ran 1 command" : `Ran ${n} commands`),
	wsSummaryTodo: "Updated todos",
	wsSummaryTool: (name: string) => `Used ${name}`,
	wsSummarySteps: (n: number) => (n === 1 ? "Finished with 1 step" : `Finished with ${n} steps`),
	wsSummaryJoin: (parts: string[]) => parts.join(", "),
