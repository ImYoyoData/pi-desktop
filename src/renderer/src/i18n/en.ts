...
export const en = {
  ...
  loadedForReEdit: "Loaded into the composer — sending will restart from here",
  open: "Open",
  ...
  marketHint:
    "Browse and install Pi extensions, skills, prompts, and shortcuts. Open the npm catalog, or install the official marketplace extension via CLI.",
  ...
  marketInstallCopied: "Install command copied — run it in a terminal",
